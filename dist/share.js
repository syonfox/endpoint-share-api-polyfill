...
function GetSocialMediaSites_WithShareLinks_SyonPreferred() {
  return ['google.bookmarks', 'telegram.me', 'email', 'gmail', 'yahoo', 'sms', 'whatsapp', 'twitter', 'facebook', 'linkedin', 'threema', 'line.me', 'skype', 'reddit', 'tumblr' // 'pinterest',
  // 'blogger',
  // 'livejournal',
  // 'evernote',
  // 'add.this',
...
function GetSocialMediaSites_WithShareLinks_OrderedByAlphabet() {
  var nice_names = GetSocialMediaSites_NiceNames();
...
function GetSocialMediaSiteLinks_WithShareLinks(args) {
  ...
  var desc = fixedEncodeURIComponent(args.desc);
  var app_id = fixedEncodeURIComponent(args.appid);
  var redirect_url = fixedEncodeURIComponent(args.redirecturl);
  var via = fixedEncodeURIComponent(args.via);
  var hash_tags = fixedEncodeURIComponent(args.hashtags);
  var provider = fixedEncodeURIComponent(args.provider);
...
var SharePolyfill = /*#__PURE__*/function () {
  _createClass(SharePolyfill, null, [{
     ...
     * }
     */
    value: function getDefaultShareTargets() {
      ...
      targets.push(new ShareTarget({
        ...
        share_target: {
          ...
          params: {
            url: 'url',
            text: 'text',
            phone_number: 'phone_number' // hash_tags: 'hashtags'
...
var sharePolyfill = new SharePolyfill(); // navigator.share = navigator.share || navigator.sharePolyfill;
